...
export const products = process.env.GDAX_PRODUCTS.split(',')
...
export const granularities = process.env.GDAX_GRANULARITIES ? process.env.GDAX_GRANULARITIES.split(',').map(Number) : [60, 900]
